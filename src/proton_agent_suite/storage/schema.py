...
class OutboundMailRow(Base):
    __tablename__ = "outbound_mail"
    id: Mapped[str] = mapped_column(String(32), primary_key=True)
    message_id_header: Mapped[str | None] = mapped_column(String(998), nullable=True, unique=True, index=True)
    subject: Mapped[str | None] = mapped_column(Text, nullable=True)
    to_addresses: Mapped[str] = mapped_column(Text, default="")
    cc_addresses: Mapped[str] = mapped_column(Text, default="")
    bcc_addresses: Mapped[str] = mapped_column(Text, default="")
    source_message_ref: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True)
    related_invite_uid: Mapped[str | None] = mapped_column(String(255), nullable=True, index=True)
    invite_sequence: Mapped[int | None] = mapped_column(Integer, nullable=True)
...
class InviteRecordRow(Base):
    ...
    organizer_common_name: Mapped[str | None] = mapped_column(String(255), nullable=True)
    ...
    calendar_ref: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True)
    calendar_href: Mapped[str | None] = mapped_column(String(2048), nullable=True)
    calendar_etag: Mapped[str | None] = mapped_column(String(255), nullable=True)
    source_message_ref: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True)
    outbound_mail_ref: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True)
    outbound_message_id: Mapped[str | None] = mapped_column(String(998), nullable=True)
